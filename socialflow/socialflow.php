...
<style type="text/css">
	...
	function save_post( $post_id ) {
		...
		$this->save_message( $post_id, $this->sanitize_message( $_POST['socialflow']['text'] ) );
	}
	...
	public function save_message( $post_id, $message = '' ) {
		return update_post_meta( $post_id, 'sf_text', $message );
	}

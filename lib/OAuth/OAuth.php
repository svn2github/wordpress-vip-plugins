<?php
/**
 * This is a forked version of the MIT licensed OAuth library for PHP
 * developed by Andy Smith (http://term.ie) and available at:
 *
 * http://oauth.googlecode.com/svn/code/php/
 *
 * The purpose of this fork is to standardize the code to be more readable
 * per current WordPress core coding standards.
 *
 * The forked version of Abraham's Twitter Library requires this file to load
 * first in order to perform anything with the Twitter API.
 *
 */

	...
	function shortcode( $atts ) {
		...
		*/
		...
		if ( !is_feed() ) {
			...
			$output .= '<div class="ooyala-video-wrapper">';
			$output .= '<script src="'. esc_url( $url ) .'"></script>';
			$output .= '<noscript>';
			$output .= "<object classid='clsid:D27CDB6E-AE6D-11cf-96B8-444553540000' id='ooyalaPlayer_7n2iz_gewtz7xi' width='{$width}' height='{$height}' codebase='http://fpdownload.macromedia.com/get/flashplayer/current/swflash.cab'>";

...
class NDN_Plugin_Admin
{
    ...
    public static $start_behavior_options = array(
        ...
        'defer_tracking_roup_level' => array(
            'name' => 'Defer to tracking group level',
            'value' => '10',
        ),
    ...
    /**
     * Set google analytics with user id
     */
    /** public static function set_google_analytics()
    {
        ?>
        ...
        <?php
        if ( self::$configured ) {
            $gacode = "ga('create', 'UA-65160109-1', { 'userId': '%s' });";
            ?>
            <script type="text/javascript">
                <?php echo sprintf( $gacode, get_option( 'ndn_default_tracking_group' ) );?>
            </script>
            <?php
        } else {
            $gacode = "ga('create', 'UA-65160109-1', 'auto');";
            ?>
            <script type="text/javascript">
                <?php echo $gacode; ?>
            </script>
        ...
        ?>
        <script type="text/javascript">
            <?php echo "ga('send', 'pageview', 'wordpress-plugin');"; ?>
        </script>
        <?php
    }
    */
    ...
    public function submit_search_query()
    {
        ...
        if (isset( $_POST['search-action']) && '1' == $_POST['search-action']) {
            ...
            $search_video_type = sanitize_text_field( $_POST['search-video-type'] ); 

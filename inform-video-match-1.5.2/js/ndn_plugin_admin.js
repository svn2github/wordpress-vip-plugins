...
// Media Wizard
  ...
  jQuery(document).click(function(e) {    
    var container = $("#ui-datepicker-div"),
        target = $(e.target);
        // console.log("col: "+target.is("#ui-datepicker-div"));
        console.log((e.target.id == "ui-datepicker-div") +"   ||  size "+ $(e.target).parents("#ui-datepicker-div").size());
      if($(e.target).parents("#ui-datepicker-div").size() === 0){
        console.log("console inside");
        jQuery('#ndn-advance-search').hide();
      }  
  });
	jQuery('#ndn-advance-search').click(function(e){
	e.stopPropagation();
	 });*/

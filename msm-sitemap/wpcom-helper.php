...
// Only allow on certain sites right now
if ( ! in_array( get_current_blog_id(), array(
	19643265, // batmoo's sandbox
	2235322, // vip
) ) ) {
		remove_action( 'after_setup_theme', array( 'Metro_Sitemap', 'setup' ) );
}

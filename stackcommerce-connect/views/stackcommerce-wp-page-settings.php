...
<div class="wrap">
  ...
  <input type="hidden" id="stackcommerce_wp_endpoint" value="<?php echo esc_url( $scwp_site_url ); ?>/index.php?sc-api-version=<?php echo esc_url( $scwp_api_version ); ?>&sc-api-route=posts" />

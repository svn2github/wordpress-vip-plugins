    ...
    <div class='lfapps-env-select-row clearfix'>
        <div class='lfapps-env-box lfapps-community'>            
            <label for="lfapps-community-env-radio">                
                ...
                <p><?php esc_html_e('Our free community comment and sidenote products that are ideal for bloggers. Learn more > ', 'lfapps'); ?> <a href='https://web.livefyre.com/'>Comments</a></br></p>
            </label>            
        </div>
        <div class='lfapps-env-box lfapps-enterprise'>
            <label for="lfapps-enterprise-env-radio">   
                ...
                <p><?php esc_html_e('For high-volume publishers and brands who want access to all Livefyre apps, enterprise support and ownership of user data. Enterprise API key required. Learn more >', 'lfapps');?> <a href='https://web.livefyre.com/streamhub/'>Streamhub</a></p>
            </label>            
        </div>
    </div>

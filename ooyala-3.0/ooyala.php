...
class Ooyala {
	...
	function shortcode( $atts, $content = null ) {
		...
		if ( !isset( $named_scripts ) ) {
			...
			// print the main script with plugins
			?>
			<script src="<?php echo esc_url( 'http://player.ooyala.com/core/' . $atts['player_id'] . '?plugins=' . implode( ',', $named_scripts ) ); ?>"></script>
			<?php

			// cycle thru all additional scripts

...
(function() {
	tinymce.create('tinymce.plugins.MultipageButtons', {
		...
		init:function(ed,url) {
			...
			var pb = '<img src="'+url+'/img/trans.gif" class="mceNextPage mceItemNoResize" />', cls= 'mceNextPage', sep=ed.getParam('nextpage_separator','<!--nextpage-->'),pbRE;
			...
			ed.onInit.add(function() {
				...
				if (ed.theme.onResolveName) {
					ed.theme.onResolveName.add(function(th, o) {
						...
						if (o.node.nodeName == 'IMG' && ed.dom.hasClass(o.node, 'mcePageTitle'))
							o.name = 'pagetitle';
					});
				}
			});
			...
			ed.onNodeChange.add(function(ed, cm, n) {
				cm.setActive('nextpage', n.nodeName === 'IMG' && ed.dom.hasClass(n, cls));
			...
			ed.onBeforeSetContent.add(function(ed, o) {
				o.content = o.content.replace(/<!--pagetitle:/g, pageHTML);
				o.content = o.content.replace(/-->/g, pageHTML2);

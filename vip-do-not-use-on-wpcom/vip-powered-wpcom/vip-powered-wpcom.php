	...
	$vip_powered_wpcom_images = array(
		...
		if ( array_key_exists( $image, $vip_powered_wpcom_images ) )
			if ( function_exists( 'staticize_subdomain' ) )
				return '<a href="' . vip_powered_wpcom_url() . '"><img src="' . staticize_subdomain( 'http://en.wordpress.com/wp-content/themes/vip/plugins/vip-powered-wpcom/images/' . $vip_powered_wpcom_images[$image][0] ) . '" width="' . $vip_powered_wpcom_images[$image][1] . '" height="' . $vip_powered_wpcom_images[$image][2] . '" /></a>';
			else
				return '<a href="' . vip_powered_wpcom_url() . '"><img src="' . get_bloginfo('url') . '/wp-content/themes/vip/plugins/vip-powered-wpcom/images/' . $vip_powered_wpcom_images[$image][0] . '" width="' . $vip_powered_wpcom_images[$image][1] . '" height="' . $vip_powered_wpcom_images[$image][2] . '" /></a>';
		else
			return '';
}
...
function vip_powered_wpcom( $display = 'text' ) {
	switch ($display) {
		case 'text':
			$output = 'Powered by <a href="' . vip_powered_wpcom_url() . '">WordPress.com VIP</a>';
			break;
		case 1:
		case 2:
		case 3:

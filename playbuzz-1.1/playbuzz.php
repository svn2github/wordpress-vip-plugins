...
include_once( plugin_dir_path( __FILE__ ) . 'class-playbuzzstorycreator.php' );  // Add Playbuzz Item post type
...
include_once( plugin_dir_path( __FILE__ ) . 'class-playbuzz-quicktags.php' );        // Add quick-tags plugin

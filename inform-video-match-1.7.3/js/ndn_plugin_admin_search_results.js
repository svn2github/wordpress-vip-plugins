( function( $ ) {
  ...
  function ndnSelectVideo(e) {
    ...
    values['ndn-playlist-id'] = $( this ).closest( '.ndn-search' ).find( '.ndn-playlist-id' ).val();
    ...
    var buildHtml = $( '<img />' )
      ...
      .attr({
        ...
        'data-config-video-id': values['ndn-video-id'],
        'data-config-widget-id': values['ndn-config-widget-id'],
        'data-config-tracking-group': values['ndn-tracking-group'],
        'data-config-site-section': values['ndn-site-section-id'],
        'ndn-responsive':  values['ndn-responsive'],
        'data-config-width': '100%',
        'data-config-height': values['ndn-video-height'],
        'data-config-playlist-id':values['ndn-playlist-id'],
        'data-config-pb': values['data-config-pb'],
        'data-config-aspect-ratio': "16:9",

						...
						<div class="inside">
							...
							<?php else :
								...
								$ndn_settings = array (
									...
									'ndn_default_playlist_id' => get_option('ndn_default_playlist_id') 
								);
							?>

							<form name="ndn-plugin-default-settings-form" id = "ndn-plugin-default-settings-form" method="post" action="" analytics-category="WPSettings" analytics-label="SettingsPageSave" novalidate>
								...
								<div class="postbox">
									...
									<fieldset style="margin:10px 0;padding:0 12px;">
										...
										<input name="<?php echo esc_attr( self::$settings_form_options['ndn_default_div_class'] ) ?>" id="<?php echo esc_attr( self::$settings_form_options['ndn_default_div_class'] ) ?>" type="text" value="<?php echo esc_attr($ndn_settings['ndn_default_div_class']) ?>" class="regular-text" /><br />
									</fieldset>

									<fieldset style="margin:10px 0;padding:0 12px;">
										<div id="ndn-denied-message" style="color:red;"></div>
									</fieldset>

									<fieldset style="margin:10px 0;padding:0 12px;">
										<label for="<?php echo esc_attr( self::$settings_form_options['ndn_default_playlist_id'] ) ?>">Default Playlist ID</label><br />
										<input name="<?php echo esc_attr( self::$settings_form_options['ndn_default_playlist_id'] ) ?>" type="text" value="<?php echo esc_attr($ndn_settings['ndn_default_playlist_id']) ?>" class="regular-text" /><br />
									</fieldset>
								...
								<h3><span><?php esc_html_e( 'Display', 'ndn_admin' ); ?></span></h3>
									...
									<?php wp_nonce_field( 'ndn_save_nonce_action', 'ndn_save_nonce_field' ); ?>
								</div>

...
Donate link: http://www.inform.com/
...
* ndn-playlist-id: Add default playlist id to your video
...
* Update style addition method
* Update script addition method
* Nonces added for configuration settings
* Unlink file of featured image

= 1.7.2 =
* Properly hook plugin with Wordpress native enqueue script
* Remove redundancy in setting data from API
* Add nonce check on submitting form information
* Remove password sanitization
* Add error handling on API response
* Add user checks and messaging on form inputs
* Update to image attribute additions
* Unlink temporary files for featured image on server

= 1.7.0 =
* The image insert into the tinymce editor having the data-config-* real attributes are added and in the public page image tag is converted to div tag.So Its overcome the div and image insertion issue in the editor.
* Start behavior values are changed as well as the data-config-pb attribute value.


= 1.6.0 =
* Rollback on <div> tag in WSYIWIG to <img>. Issues pending within Editor
* Changes description for default to tracking group level
* Uses data-config-* div attributes rather than the deprecated attributes

= 1.5.2 =
* Add support for search enhancements
* Add playlist ID support
* Add embed now script for faster video loading on pages

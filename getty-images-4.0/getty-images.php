...
class Getty_Images {
	...
	*/
	...
	function admin_enqueue() {
		...
		wp_enqueue_script( 'getty-images-blocks', plugins_url( '/js/getty-blocks.js', __FILE__ ), array(), $current_timestamp, true );
		...
		wp_enqueue_style( 'getty-blocks', plugins_url( '/css/getty-blocks.css', __FILE__ ) );

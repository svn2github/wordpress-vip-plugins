...
Description: Whenever a change to Custom DNS Settings is made, those changes are emailed to VIP Support
Version: 0.6
...
add_action( 'init', array( 'Email_Custom_DNS_Changes', 'init' ) );

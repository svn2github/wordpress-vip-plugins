...
function ssid_add() {
	...
	add_action('manage_edit-tags_columns', 'ssid_column');
	add_action('manage_categories_columns', 'ssid_column');
	...
	add_filter('manage_categories_custom_column', 'ssid_return_value', 10, 3);

...
if ( ! class_exists( 'Table_Of_Contents' ) ) :
	...
	class Table_Of_Contents {
		...
		private static function _get_tag_pattern( $tag ) {
			return "/(<{$tag}>)(.*)(<\/{$tag}>)/";
		}

		private static function get_tags_matches( $tag, $content = '' ) {
			if ( empty( $content ) ) {
		...
		private static function get_tags_and_subtags( $tag, $subtag, $content ) {

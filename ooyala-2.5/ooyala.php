			...
			<tbody>
				...
				<tr class="ooyala-v4-setting">
					...
					<td scope="row">
						...
						<label>
							<input type="checkbox" name="ooyala[optional_plugins][]" value="discovery_api.min.js" <?php is_array( $option['plugins'] ) && checked( in_array( 'discovery_api.min.js', $option['optional_plugins'], true ) ); ?> />

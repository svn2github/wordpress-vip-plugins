...
<input type="hidden" id="ap_wibiya_mobile_activate" name="ap_wibiya_mobile_activate" value="1" />
<?php
...
<div class="wibiyaWrapper">
	<div class="leftPane">
		...
		<div class="ftu">
			Your mobile site is almost ready! Enable it now.
			<a href="javascript:void(0);" class="enableButton" onclick="document.ap_wibiya_mobile_activate.submit();">Enable your mobile site</a>
			
			<div class="wpThemeNotice">
				The generic WP mobile theme will be replaced by a stunning Wibiya-powered mobile site.<br />
				You can always revert to the default theme by disabling the plugin.
			</div>
		</div>
		...
		<div class="customize">
			...
			<p><a href="javascript:void(0)" class="regularButton disabled">Customize</a> <span class="note">Be sure to enable the plugin first.</span></p>

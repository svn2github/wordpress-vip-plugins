...
class BC_Admin_Menu {
	...
	public function register_admin_menu() {
		...
		add_menu_page( esc_html__( 'Brightcove', 'brightcove' ), esc_html__( 'Brightcove', 'brightcove' ), 'edit_posts', 'brightcove', array( $this, 'render_settings_page' ) , plugins_url( 'images/admin/menu-icon.svg', dirname( dirname( __DIR__ ) ) ), 50 );

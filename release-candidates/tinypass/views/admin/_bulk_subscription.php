<?php
/**
 * Template for batch editing, when the business model is "hard / keyed paywall"
...
<fieldset class="inline-edit-col-right bulk-edit-tinypas">
	<div>
		...
		<ul class="cat-checklist category-checklist">
			<li>
				<label>
					<input type="radio" name="<?php echo esc_attr( $this::META_NAME . '[' . $contentSettings->chargeOptionPropertyName() . ']' ) ?>"

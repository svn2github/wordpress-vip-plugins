...
<?php if ( 'attachment' !== $post->post_type ) : ?>
	<p class="sf-media-toggle-container"> 
		<input id="sf_media_compose" class="sf_media_compose" type="checkbox" value="1" name="socialflow[compose_media]" <?php checked( absint( get_post_meta( $post->ID, 'sf_compose_media', true ) ), 1 ); ?> />

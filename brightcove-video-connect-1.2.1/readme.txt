...
= 1.2.1 =
* Enhancement: Add filter to shortcode player HTML
* Enhancement: Add support for the Heartbeat API, passing 10 most recently updated videos
* Enhancement: Add support for callback functionality, allowing Brightcove to flush cache when an ingested asset changes.
* Fix: Fix issue where spinner was not always shown on initial load
* Fix: Update logic to fix issue where playlist shortcode was mistakenly inserted

...
(function($) {
	...
	ooyala.view.TitleBar = media.View.extend({
		...
		changeAccount: function(ev) {
			// Attach current account to global ooyala object
			ooyala.settings.account = ev.target.value;
			$('.search-results-refresh').click();
		},
		...
		showBrowser: function() {
			this.controller.frame.content.mode('ooyala-browse');
			//Refresh on return to browser in case account was changed
			$('.search-results-refresh').click();
		},
	});
